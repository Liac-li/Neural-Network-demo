...
class LayerBase(ABC):
    ...
    def __init__(self, optimizer='sgd', learning_rate=0.035) -> None:
        self.X = []
        self.act_fn = None
        self.trainable = True
        self.learning_rate = learning_rate
        self.optimizer = OptimizerInitializer(optimizer_name=optimizer,
                                              lr=learning_rate)()
    ...
    def update(self):
        ...
        self.params = self.optimizer(self.params, self.gradients)
...
class Dense(LayerBase):
    ...
    def __init__(self, out_size, act_fn=None, init='zero', optimizer='sgd'):
